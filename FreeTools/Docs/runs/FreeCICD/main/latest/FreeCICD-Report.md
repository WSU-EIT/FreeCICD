...
| **Total Files** | 324 |
| **Total Lines** | 86,213 |
| **Total Characters** | 3,240,031 |
| **Total Size** | 3.1 MB |
| **Avg Lines/File** | 266.1 |
...
|----------|------:|----------:|------------:|------------|
| CSharpSource | 129 | 307 | 39,591 | [███████░░░░░░░░░░░░░] 39.8% |
...
<details>
<summary><strong>Pages</strong> (42 routes)</summary>
...
graph TD
    ROOT[("/")]
    ROOT --> N1[About]
    ROOT --> N2(Authorization)
    N2 --> N3[AccessDenied]
    N2 --> N4[InvalidUser]
    N2 --> N5[NoLocalAccount]
    N2 --> N6[NoLocalAccout]
    ROOT --> N7[ChangePassword]
    ROOT --> N8[DatabaseOffline]
    ROOT --> N9[DoubleClick]
    ROOT --> N10[InvalidTenantCode]
    ROOT --> N11[Login]
    ROOT --> N12[Logout]
    ROOT --> N13[MissingTenantCode]
    ROOT --> N14[Monaco]
    ROOT --> N15[not-found]
    ROOT --> N16[PasswordChanged]
    ROOT --> N17[Pipelines]
    ROOT --> N18[Plugins]
    ROOT --> N19[ProcessLogin]
    ROOT --> N20[Profile]
    ROOT --> N21[ServerUpdated]
    ROOT --> N22[Settings]
    N22 --> N23[AddDepartment]
    N22 --> N24[AddDepartmentGroup]
    N22 --> N25[AddTag]
    N22 --> N26[AddTenant]
    N22 --> N27[AddUser]
    N22 --> N28[AddUserGroup]
    N22 --> N29[AppSettings]
    N22 --> N30[DeletedRecords]
    N22 --> N31[DepartmentGroups]
    N22 --> N32[Departments]
    N22 --> N33(EditDepartment)
    N33 --> N34[["{departmentid}"]]
    N22 --> N35(EditDepartmentGroup)
    N35 --> N36[["{departmentgroupid}"]]
    N22 --> N37(EditTag)
    N37 --> N38[1]
    N22 --> N39(EditTenant)
    N39 --> N40[["{tenantid}"]]
...
| Depth | Count | Routes |
|------:|------:|--------|
| 0 | 22 | `/About`, `/ChangePassword`, `/DatabaseOffline` +19 more |
| 2 | 21 | `/Authorization/AccessDenied`, `/Authorization/InvalidUser`, `/Authorization/NoLocalAccount` +18 more |
